...
class MenuCharacter extends FlxSprite
{
	...
	var curCharacterMap:Map<String, Array<Dynamic>> = [
		...
		'bf' => ["bf idle", 24, true, 0.6, 0, -10],
		'bfConfirm' => ['bf hey', 24, false, 0.6, 0, -10],
		'gf' => ["gf dance", 24, true, 1, 200, 200],
		'kady' => ['kady idle storymode', 24, true, 0.4, 0, 0],
		'qmark' => ['question mark', 24, true, 0.4, 50, 25]
	];
