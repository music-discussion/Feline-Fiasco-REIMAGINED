...
class DialogueBox extends FlxSpriteGroup
{
	...
	public static var nameBox:FlxSprite;
	...
	public function new(?talkingRight:Bool = false, ?daDialogue:String)
	{
		...
		nameBox = new FlxSprite(900, 400).makeGraphic(250, 50, FlxColor.WHITE);
		
		nameText = new FlxText(950, 400, 250, '', 36);
		...
		//nameText.textField.backgroundColor = FlxColor.WHITE;
	...
	public function updateDialog(force:Bool = false)
	{
		...
		{
			// Text update
			var textToDisplay = "lol u need text for dialogue";
	...
	function changeCharText(char:String)
	{
		char = curCharacter.toLowerCase();
		
		switch(char)
		{
			case 'kady':
				nameText.text = 'Kady';
				nameText.color = FlxColor.fromRGB(84, 0, 255);
				nameText.borderColor = FlxColor.fromRGB(17, 0, 68);
			case 'kadycat':
				nameText.text = 'Kady Cat';
				nameText.color = FlxColor.fromRGB(84, 0, 255);
				nameText.borderColor = FlxColor.fromRGB(17, 0, 68);
			case 'bf-kady':
				nameText.text = 'Boyfriend';
				nameText.color = FlxColor.fromRGB(0, 148, 255);
				nameText.borderColor = FlxColor.fromRGB(0, 47, 147);
			case 'gf-kady':
				nameText.text = 'Girlfriend';
				nameText.color = FlxColor.fromRGB(255, 0, 66);
				nameText.borderColor = FlxColor.fromRGB(99, 0, 11);
			case 'jace':
				nameText.text = 'Jace';
				nameText.color = FlxColor.fromRGB(255, 255, 75);
				nameText.borderColor = FlxColor.fromRGB(178, 140, 53);
			case 'tyler' | 'tyler-tb':
				nameText.text = 'Tyler';
				nameText.color = FlxColor.fromRGB(255, 140, 0);
				nameText.borderColor = FlxColor.fromRGB(119, 47, 0);
			case 'apple':
				nameText.text = 'Apple';
				nameText.color = FlxColor.fromRGB(255, 112, 159);
				nameText.borderColor = FlxColor.fromRGB(135, 32, 52);
			case 'tucker':
				nameText.text = 'Tucker';
				nameText.color = FlxColor.fromRGB(0, 165, 19);
				nameText.borderColor = FlxColor.fromRGB(26, 89, 0);
			default:
				nameText.text = 'Name';
				nameText.color = FlxColor.fromRGB(255, 255, 255);
				nameText.borderColor = FlxColor.fromRGB(0, 0, 0);
		}
	}
}
