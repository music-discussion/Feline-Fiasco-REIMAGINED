...
class Main extends Sprite
{
	...
	**/
	...
	public static var gameWeeks:Array<Dynamic> = [
		[
			['Ganghan', 'Balam', 'Keunsilsu', 'Goyangi'],
			['kady', 'kady-hairblow', 'kadycat', 'kadycat-happy'],
			[FlxColor.fromRGB(58, 5, 96)],
			"Rap Cat-astrophe"
		],

		[
			['RivalLife'], ['tyler'], [FlxColor.LIME], "A Bonus Week!"
		],

		[
			['Secret'], ['bf-kadyplayable'], [FlxColor.YELLOW], ""
		],
	];
