...
class ChartingState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		for (i in 0...keysTotal)
		{
			...
			var newArrow:UIStaticArrow = ForeverAssets.generateUIArrows(((FlxG.width / 2) - ((keysTotal / 2) * gridSize)) + ((i - 1) * gridSize),
				-76, typeReal, 'chart editor', "default");
	...
	{
		var note:Note = ForeverAssets.generateArrow(PlayState.assetModifier, daStrumTime, daNoteInfo % 4, 0, daNoteAlt, false, null, "default");
