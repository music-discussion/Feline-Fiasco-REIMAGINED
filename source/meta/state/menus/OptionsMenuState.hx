...
class OptionsMenuState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		categoryMap = [
			...
			'appearance' => [
				[
					...
					['Notes', null],
					['', null],
					//["Note Skin", getFromOption], //removing note skins so i dont have to worry about kady's note skins for each style
		...
		var bd = new FlxBackdrop(Paths.image('menus/base/title/bdSettings'), 1, 1, true, true);
		add(bd);
